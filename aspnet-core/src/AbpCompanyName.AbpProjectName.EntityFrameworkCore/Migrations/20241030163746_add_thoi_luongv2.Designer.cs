...
namespace AbpCompanyName.AbpProjectName.Migrations
{
    ...
    [Migration("20241030163746_add_thoi_luongv2")]
    partial class add_thoi_luongv2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AbpCompanyName.AbpProjectName.Model.CayGold.GiaoDichGold", b =>
                {
                    ...
                    b.Property<bool>("IsChuaThanhToan")
                        .HasColumnType("bit");

                    b.Property<bool>("IsDeleted")
                        .HasColumnType("bit");

                    b.Property<bool>("IsThanhToanNo")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("GiaoDichGold", "gold");
                });

            modelBuilder.Entity("AbpCompanyName.AbpProjectName.Model.CayGold.KhachHang.KHACHANG", b =>
                {
                    b.Property<string>("MaKhachHang")
                    ...
                    b.Property<int?>("SoTienConNo")
                        .HasColumnType("int");

                    b.Property<int?>("SoTienConThua")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AbpCompanyName.AbpProjectName.Model.CayGold.TaiKhoan.TaiKhoan", b =>
                {
                    b.Property<string>("TenTaiKhoan")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("TaiKhoan", "tk");
                });

            modelBuilder.Entity("AbpCompanyName.AbpProjectName.Model.CayGold.ViewGiaoDichGold", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("NoteKhachHang")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("NoteTaiKhoan")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("ViewGiaoDichGold");
                });

            modelBuilder.Entity("AbpCompanyName.AbpProjectName.Model.HocKyNangs.HocKyNang", b =>
                {
                    ...
                    b.ToTable("HocKyNangs", "st");
                });

            modelBuilder.Entity("AbpCompanyName.AbpProjectName.Model.HocKyNangs.HocKyNangCT", b =>
                {
                    b.Property<int>("MaHocKyNangCT")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("MaHocKyNangCT");

                    b.ToTable("HocKyNangCTs", "st");
                });

            modelBuilder.Entity("AbpCompanyName.AbpProjectName.Model.HocKyNangs.ViewHocKyNang", b =>
                {
                    b.Property<int>("MaHocKyNang")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ViewHocKyNangs", "st");
                });

            modelBuilder.Entity("AbpCompanyName.AbpProjectName.Model.HocKyNangs.ViewHocKyNangCT", b =>
                {
                    b.Property<int>("MaHocKyNangCT")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
