...
interface IHoanTraMatBangProps {
    linkedID: string;
    tenKhachHang: string;
    soDienThoai: string;
    onSuccess: () => void;
...
const HoanTraMatBang = observer(({ linkedID, onSuccess, tenKhachHang = "", soDienThoai = "" }: IHoanTraMatBangProps) => {
    ...
    return (
        <Spin spinning={spinning}>
            <Form {...formItemLayout} onFinish={onFinish} onFinishFailed={onFinishFailed}>
                <Form.Item
                    label="Địa chỉ chưa hoàn trả mặt bằng"
                    name="diaChi"
