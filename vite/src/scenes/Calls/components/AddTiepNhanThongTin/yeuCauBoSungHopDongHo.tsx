...
interface IYeuCauBoSungHopDongHoProps {
    linkedID: string;
    tenKhachHang: string;
    soDienThoai: string;
    onSuccess: () => void;
...
const YeuCauBoSungHopDongHo = observer(({ linkedID, onSuccess, tenKhachHang = "", soDienThoai = "" }: IYeuCauBoSungHopDongHoProps) => {
    ...
    const onFinish = async (values: any) => {
        ...
        try {
            await tiepNhanThongTinStore.create({
                ...
                LinkedID: linkedID,
                LoaiThongTin: "yeuCauBoSungHopDongHo",
...
export default YeuCauBoSungHopDongHo;
