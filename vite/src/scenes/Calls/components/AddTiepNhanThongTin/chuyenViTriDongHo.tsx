...
interface IChuyenViTriDongHoProps {
    linkedID: string;
    tenKhachHang: string;
    soDienThoai: string;
    onSuccess: () => void;
...
const ChuyenViTriDongHo = observer(({ linkedID, onSuccess, tenKhachHang = "", soDienThoai = "" }: IChuyenViTriDongHoProps) => {
    ...
    const onFinish = async (values: any) => {
        ...
        try {
            await tiepNhanThongTinStore.create({
                ...
                LinkedID: linkedID,
                LoaiThongTin: "chuyenViTriDongHo",
...
export default ChuyenViTriDongHo;
