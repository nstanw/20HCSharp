...
const KiemTraDongHo = observer(({ linkedID, onSuccess, tenKhachHang = "", soDienThoai = "", maPhongBan = "" }: IKiemTraDongHoProps) => {
    ...
    const onFinish = async (values: any) => {
        ...
        try {
            await tiepNhanThongTinStore.create({
                ...
                LinkedID: linkedID,
                LoaiThongTin: "kiemTraDongHo",
                NoiDungYeuCau: values.NoiDungYeuCau,
                MaPhongBan: maPhongBan === "" ? "YKKH" : "PKT",
