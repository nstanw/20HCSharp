...
interface IYeuCauKepChiDongHoProps {
    linkedID: string;
    tenKhachHang: string;
    soDienThoai: string;
    onSuccess: () => void;
...
const YeuCauKepChiDongHo = observer(({ linkedID, onSuccess, tenKhachHang = "", soDienThoai = "" }: IYeuCauKepChiDongHoProps) => {
    ...
    const onFinish = async (values: any) => {
        ...
        try {
            await tiepNhanThongTinStore.create({
                ...
                LinkedID: linkedID,
                LoaiThongTin: "yeuCauKepChiDongHo",
...
export default YeuCauKepChiDongHo;
